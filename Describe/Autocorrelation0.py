...
plot_pacf(df_materials, lags=44, title='Partial Autocorrelation Function for Building Materials', ax=ax1)
plot_pacf(df_cement, lags=44, title='Partial Autocorrelation Function for Cement Production', ax=ax2)
